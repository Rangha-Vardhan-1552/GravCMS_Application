...
return [
    ...
    'timestamp' => 1713183897,
    'checksum' => '470838d9594f1d427845f88dd07a1529',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/chatbot' => [
                'file' => 'user/plugins/chatbot/blueprints.yaml',
                'modified' => 1713180595
            ],
            'plugins/devtools' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.chatbot.enabled' => [
                ...
                'name' => 'plugins.chatbot.enabled',
                'validation' => 'loose'
            ],
            'plugins.chatbot.chatbot_name' => [
                'type' => 'text',
                'label' => 'Chatbot_name',
                'name' => 'plugins.chatbot.chatbot_name',
                'validation' => 'loose'
            ],
            'plugins.chatbot.api_url' => [
                'type' => 'text',
                'label' => 'API URL',
                ...
                'name' => 'plugins.chatbot.api_url',
                'validation' => 'loose'
            ],
            'plugins.chatbot.query_param' => [
                'type' => 'select',
                ...
                'name' => 'plugins.chatbot.query_param',
                'validation' => 'loose'
            ],
            'plugins.chatbot.query_output' => [
                'type' => 'select',
                'label' => 'Query Output',
                'options' => [
                    'JSON' => 'JSON',
                ...
                'name' => 'plugins.chatbot.query_output',
                'validation' => 'loose'
            ],
            'plugins.chatbot.Latitude' => [
                'type' => 'number',
                'label' => 'Latitude',
                'name' => 'plugins.chatbot.Latitude',
                'validation' => 'loose'
            ],
            'plugins.chatbot.Longitude' => [
                'type' => 'number',
                'label' => 'Longitude',
                'name' => 'plugins.chatbot.Longitude',
                'validation' => 'loose'
            ],
            'plugins.devtools' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'chatbot' => [
                    'enabled' => 'plugins.chatbot.enabled',
                    'chatbot_name' => 'plugins.chatbot.chatbot_name',
                    'api_url' => 'plugins.chatbot.api_url',
                    'query_param' => 'plugins.chatbot.query_param',
                    'query_output' => 'plugins.chatbot.query_output',
                    'Latitude' => 'plugins.chatbot.Latitude',
                    'Longitude' => 'plugins.chatbot.Longitude'
                ],
                'devtools' => [
